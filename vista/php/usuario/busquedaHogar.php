...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="container-fluid">
            <form class="d-flex input" action="busquedaHoagr.php" method="post">
        ...
        if (isset($_POST['enviar'])) {
            ...
            $consulta = $conn->prepare("SELECT * FROM productoshogar WHERE titulo LIKE ? OR descripcion LIKE ? OR precio LIKE ?");
