...
$actualizar = "UPDATE productosanimales SET imagen = ?, titulo = ?, descripcion = ?, cantidad = ?, precio = ? WHERE id = ?";

// Preparar la declaración
if ($stmt = mysqli_prepare($conn, $actualizar)) {
    // Enlazar los parámetros
    mysqli_stmt_bind_param($stmt, "sssssi", $imagen, $titulo, $descripcion, $cantidasd, $precio, $id);
