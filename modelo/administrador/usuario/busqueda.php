                ...
                <div class="row justify-content-start">
                    <div class="columna col-lg-12">
                        ...
                        if (isset($_POST['enviar'])) {
                            ...
                            $consulta = $conn->prepare("SELECT u.id, u.nombre, u.apellido, u.telefono, u.correo, r.rol
                            FROM usuarios u
                            LEFT JOIN rol r ON u.id = r.usuario_id
                            WHERE u.nombre LIKE ? OR u.apellido LIKE ? OR u.telefono LIKE ? OR u.correo LIKE ? OR r.rol LIKE ?");
                            $busqueda_param = "%$busqueda%";
                            $consulta->bind_param("sssss", $busqueda_param, $busqueda_param, $busqueda_param, $busqueda_param, $busqueda_param);
